...
如果出现`Metadata kept in Windows cache, refused to mount.`的报错，是因为双系统中Windows的硬盘并未完全关闭，原因在Windows的快速启动功能，一种办法是关闭系统重启，进入Windows的恩


<!--stackedit_data:
eyJoaXN0b3J5IjpbMjQ2MDcxMjgyLDEzMzYzODE2NjMsLTU3Mz
c4NTEyMV19
-->